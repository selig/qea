 ...
 * @author Giles Reger
 */
public class NonSimpleDetGenQEA extends NonSimpleQEA {
	...
	/**
	 * Creates a <code>NonSimpleDetGenQEA</code> for the specified number of
	 ...
	 */
	public NonSimpleDetGenQEA(int numStates, int numEvents, int initialState,
	...
	public DetConfig getNextConfig(DetConfig config, int event, Object[] args) {
		...
		// TODO This method is very similar to getNextConfig in NonSimpleDetQEA
