 ...
 * @author Giles Reger
 */
public class NonSimpleNonDetGenQEA extends NonSimpleQEA {
	...
	/**
	 * Creates a <code>NonSimpleNonDetGenQEA</code> for the specified number of
	 ...
	 */
	public NonSimpleNonDetGenQEA(int numStates, int numEvents,
