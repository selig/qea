...
public class Scenarios {
	...
	private static void scenario(Integer n) {
		...
		case 2:
			...
			tr.ADMIN_makeGoldUser(uid);
			break;
		// PROPERTY 2: The transaction system must be initialised before any
		// user logs in.
		case 3:
			// P2 violation
			uid = tr.ADMIN_createUser("Fred", "France");
		...
		case 6:
			...
			tr.USER_payToExternal(uid, sid, account_number, 100);
			break;
		// PROPERTY 4: An account approved by the administrator may not have the
		// same
		...
		case 7:
			...
			// Account 1 of user 11 and account 11 of user 1 will both be named
			// "111"
			break;
		case 8:
			// P4 non-violation
			...
			break;
		// PROPERTY 5: Once a user is disabled by the administrator, he or she
		// may not
		// withdraw from an account until being activated again by the
		// administrator.
		case 9:
			// P5 violation
			tr.ADMIN_initialise();
		...
		case 10:
			...
			tr.USER_payToExternal(uid, sid, account_number, 200);
			break;
		// PROPERTY 6: Once greylisted, a user must perform at least three
		// external
		...
		case 11:
			...
			account_number_receiver = tr.USER_requestAccount(uid_receiver,
					sid_receiver);
		...
		case 14:
			...
			tr.USER_logout(uid, sid);
			break;
		// PROPERTY 8: The administrator must reconcile accounts every 1000
		// external money
		// transfers or an aggregate total of one million dollars in external
		// transfers.
		case 15:
			// P8 violation
			tr.ADMIN_initialise();
		...
		case 18:
			...
			break;
		// PROPERTY 10: Transfers may only be made during an active session
		// (i.e. between a login and a logout)
		case 19:
			// violation
			tr.ADMIN_initialise();
			uid_receiver = tr.ADMIN_createUser("Roger", "Romania");
		...
		case 20:
			...
			for (Integer i = 0; i < 5; i++) {
				...
				tr.USER_depositFromExternal(uid, sid, account_number, 1000);
				tr.USER_payToExternal(uid, sid, account_number, 100);
				tr.USER_transferToOtherAccount(uid, sid, account_number,
						uid_receiver, account_number_receiver, 100);
				tr.USER_logout(uid, sid);
			}
			break;
		default:
			System.out.println("Requested scenario " + n.toString()
