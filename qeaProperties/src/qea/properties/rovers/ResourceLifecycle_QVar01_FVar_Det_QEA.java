...
public class ResourceLifecycle_QVar01_FVar_Det_QEA extends QVar01_FVar_Det_QEA {

	public ResourceLifecycle_QVar01_FVar_Det_QEA() {
		super(3, 5, 1, FORALL, 0);
		setName("ResourceLifecycle_QVar01_FVar_Det_QEA");
